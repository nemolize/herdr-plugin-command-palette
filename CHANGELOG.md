...
## [0.3.0](https://github.com/nemolize/herdr-plugin-command-palette/compare/v0.2.0...v0.3.0) (2026-09-05)


### Features

* cut releases by merging a release PR instead of hand-tagging ([e36ef43](https://github.com/nemolize/herdr-plugin-command-palette/commit/e36ef43850a70baa33889d3e560d970901b12658))
...
* stop drawing a second frame inside the pane ([dda6e1d](https://github.com/nemolize/herdr-plugin-command-palette/commit/dda6e1d733cb58ecf70a02e9c4c594d0900e206b))
...
* supply the --split that `pane move --tab` requires ([e2f6430](https://github.com/nemolize/herdr-plugin-command-palette/commit/e2f6430fe24f3f492719f9572853bdeeffdf84ee))
* supply the --split that `pane move --tab` requires ([ff9b455](https://github.com/nemolize/herdr-plugin-command-palette/commit/ff9b455d1656bc44b7a1f92cc9adcefff09ad4cc))
